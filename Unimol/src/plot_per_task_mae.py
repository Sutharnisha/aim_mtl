"""
Per-task test MAE, one bar per method -- Uni-Mol backbone.
...
------------------------
    python plot_per_task_mae.py --results_dir ../results_11task
    python plot_per_task_mae.py --results_dir ../results_2task
    python plot_per_task_mae.py --results_dir E:/Projects/Results/Unimol/results_11task
    python plot_per_task_mae.py --tasks mu eps_LUMO      # subset of what is there
    python plot_per_task_mae.py --out ../unimol_plots
...
BACKBONE = "Uni-Mol"
DEFAULT_RESULTS = "../results_11task"
...
def main() -> None:
    ...
    ap.add_argument("--results_dir", default=DEFAULT_RESULTS,
                    help="run tree, e.g. ../results_11task or ../results_2task")
